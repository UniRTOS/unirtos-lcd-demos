...
* </table>
**********************************************************************/
#ifndef __EC800Z_CNLD_PIN_H__
#define __EC800Z_CNLD_PIN_H__
...
#define UNIR_LCD_PORT         QOSA_LCD_SPI_PORT_1

// EC800ZCNLD SPI PIN
#define UNIR_LCD_RST_PIN      (49)
#define UNIR_LCD_RST_FUNC     (0)  // GPIO Control reset

#define UNIR_LCD_CS_PIN       (52)
#define UNIR_LCD_CS_FUNC      (0)  // GPIO Control CS

#define UNIR_LCD_DS_PIN       (51)
#define UNIR_LCD_DS_FUNC      (0)  // GPIO Control DS

#define UNIR_LCD_DOUT_PIN     (50)
#define UNIR_LCD_DOUT_FUNC    (1)

#define UNIR_LCD_DIN_PIN      -1
#define UNIR_LCD_DIN_FUNC     (-1)

#define UNIR_LCD_CLK_PIN      (53)
#define UNIR_LCD_CLK_FUNC     (1)

#endif /* __EC800Z_CNLD_PIN_H__ */
